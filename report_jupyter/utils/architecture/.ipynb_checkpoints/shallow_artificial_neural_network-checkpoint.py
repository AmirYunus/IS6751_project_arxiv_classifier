...
class ShallowNeuralNetwork(nn.Module):
    def __init__(self, input_dim: int, hidden_dim: int = 128, learning_rate: float = 1e-3):
        """
        Initialize shallow neural network model.
        ...
        # Initialize model with one hidden layer
    ...
    def fit(self, X_train: np.ndarray, y_train: np.ndarray,
        ...
        for epoch in progress_bar:
            ...
            plt.tight_layout()
            plt.savefig('./visualisations/shallow_artificial_neural_network_training_plot.png')
            plt.show()
        ...
        imageio.mimsave('./visualisations/shallow_artificial_neural_network_training.gif', frames, fps=2)
    ...
    def predict(self, X: np.ndarray, y_test: np.ndarray = None, display_metrics: bool = True) -> np.ndarray:
        ...
        if display_metrics and y_test is not None:
            ...
            plt.ylabel('True')
            plt.savefig('./visualisations/shallow_artificial_neural_network_confusion_matrix.png')
            plt.show()
