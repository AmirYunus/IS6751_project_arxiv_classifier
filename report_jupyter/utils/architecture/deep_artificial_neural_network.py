...
class DeepNeuralNetwork(nn.Module):
    ...
    def fit(self, X_train: np.ndarray, y_train: np.ndarray,
        ...
        for epoch in progress_bar:
            ...
            plt.tight_layout()
            plt.savefig('./visualisations/deep_artificial_neural_network_training_plot.png')
        ...
        imageio.mimsave('./visualisations/deep_artificial_neural_network_training.gif', frames, fps=2)
    ...
    def predict(self, X: np.ndarray, y_test: np.ndarray = None, display_metrics: bool = True) -> np.ndarray:
        ...
        if display_metrics and y_test is not None:
            ...
            plt.ylabel('True')
            plt.savefig('./visualisations/deep_artificial_neural_network_confusion_matrix.png')
            plt.show()
